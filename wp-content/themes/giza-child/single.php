...
<div id="st-container" class="st-container">
		...
		<div class="po-section section-background-white" style="padding:50px 0 100px; background-color:#fff;">
          ...
          <div class="shared-links-wrapper clearfix">
            <div class="sl-inner">
              <div class="tweet-this-blockquote sl-title">
                <?php the_title(); ?>
              </div>
              <div class="share-links-pretty">
                  <span class="sl-link tw">
                    <a href="https://twitter.com/share?url=<?php the_permalink(); ?>" onClick="javascript:window.open(this.href,
                      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=260,width=600');return false;">
                      <span class="index twit"><i class="fa fa-twitter"></i></span>
                      Tweet
                    </a>
                  </span><span class="sl-link fb">
                    <a href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>" onClick="javascript:window.open(this.href,
                                      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=220,width=600');return false;">
                      <span class="index fb"><i class="fa fa-facebook"></i></span>
                      Post
                    </a>
                  </span>
              </div>
        ...
        <?php } ?>
            ...
            if ($related_items->have_posts()) :
            	echo
                '
                <div class="" data-delay="0" data-animation="fade-in" style="padding:0;" >
                <div class="related-dwrapper" style="height:200px;">';
                      $counter = 0;
                      while ( $related_items->have_posts() && $counter < 2 ) : $related_items->the_post();
                      $counter++;
                      global $post;
                    ...
                    <div class="flex-row" style="background-image: url(' <?php echo esc_url($url); ?> ');">
            ...
            echo do_shortcode('[mc4wp_form id="1229"]');
